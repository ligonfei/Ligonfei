...
const rurekey = {
  ...
  澳大利亚: /澳洲|墨尔本|悉尼|土澳|(深|沪|呼|京|广|杭)澳|\bau\b/gi,
  德国: /(深|沪|呼|京|广|杭)德(?!.*(I|线))|法兰克福|滬德|\bde\b/gi,
  香港: /(深|沪|呼|京|广|杭)港(?!.*(I|线))|\bhk\b/gi,
  日本: /(深|沪|呼|京|广|杭|中|辽)日(?!.*(I|线))|东京|大坂|\bjp\b/gi,
  新加坡: /狮城|(深|沪|呼|京|广|杭)新|\bsg\b/gi,
  美国: /(深|沪|呼|京|广|杭)美|波特兰|芝加哥|哥伦布|纽约|硅谷|俄勒冈|西雅图|芝加哥|\bus\b/gi,
  波斯尼亚和黑塞哥维那: /波黑共和国/g,
  印尼: /印度尼西亚|雅加达|\bid\b/gi,
  印度: /孟买|\bin\b/gi,
  阿联酋: /迪拜|阿拉伯联合酋长国|\bae\b/gi,
  孟加拉国: /孟加拉|\bbd\b/gi,
  捷克: /捷克共和国|\bcz\b/gi,
  台湾: /新台|新北|台(?!.*线)|\btw\b/gi,
  Taiwan: /Taipei/g,
  韩国: /春川|韩|首尔|\bkr\b/gi,
  Japan: /Tokyo|Osaka/g,
  英国: /伦敦|\buk\b|\bgb\b/gi,
  India: /Mumbai/g,
  Germany: /Frankfurt/g,
